...
#include <fstream>
#include <ctime>
#include <cstdlib> // Библиотеки ctime и cstdlib нужны для рандомизации, простым языком ctime мы задаем что-то типо как сид в майнкрафте, а cstdlib уже нужен для команд рандома
#include <string>
